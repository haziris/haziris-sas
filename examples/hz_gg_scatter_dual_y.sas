...
data options;
  ...
  o = "{";                                                           output;
  o = "  series: {";                                                 output;
  o = "    0: {targetAxisIndex: '0'},";                              output;
  o = "    1: {targetAxisIndex: '1'}";                               output;
  o = "  },";                                                        output;
  o = "  title: 'Students Final Grades - based on hours studied',";  output;
  o = "  vAxes: {";                                                  output;
  o = "    0: {title: 'HoursStudied'},";                            output;
  o = "    1: {title: 'FinalGrade'}";                          output;
  o = "  }";                                                         output;
  o = "}";                                                           output;
run;
...
%hz_gg_scatter(
  intable = temp, 
  outfile = "&hz_loc./examples/hz_gg_scatter_dual_y.html",
  options = options
);